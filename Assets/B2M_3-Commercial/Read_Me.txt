...
- Bitmap2Material_3.sbsar: this filter can be used within Unity and any other Substance integration to create a full PBR material
...
Bitmap2Material_3.sbsar can be used by both PBR mode: Standard (Metallic/Smoothness=Glossiness) and Standard Specular setup (Specular/Smoothness=Glossiness). The filter will automatically generate the necessary outputs (and pack them correctly to fit Unity PBR shaders convention) depending on the current shader selection.

Here are the steps to use B2M3 in Unity:
1) Drag&Drop the substance called "Bitmap2Material_3" on a mesh
